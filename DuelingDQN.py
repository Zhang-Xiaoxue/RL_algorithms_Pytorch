...
class Agent(object):
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, 
                 mem_size=100000, eps_min=0.01, eps_dec=5e-7, replace=1000, chkpt_dir='tmp/duelingdqn'):
        self.gamma = gamma
    ...
    def learn(self):
        ...
        q_pred = torch.add(V_s, (A_s - A_s.mean(dim=1, keepdim=True))).gather(1, action_batch.unsqueeze(-1)).squeeze(-1)
...
if __name__ == '__main__':
    ...
    filename = env_name + '_DuelingDQN.png'
