...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, lr, fc1_dims=256, fc2_dims=256, chkpt_dir='tmp/ppo_discrete'):
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, lr, fc1_dims=256, fc2_dims=256, chkpt_dir='tmp/ppo_discrete'):
...
class Agent:
    def __init__(self, n_actions, input_dims, gamma=0.99, lr=0.0003, gae_lambda=0.95, 
        ...
        self.actor = ActorNetwork(n_actions=n_actions, input_dims=input_dims, lr=lr)
...
if __name__ == '__main__':
    ...
    filename = env_name + '_PPO_discrete.png'
